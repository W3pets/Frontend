    ...
    <div className='scrollbar-style fixed h-5/6 overflow-y-scroll'>
      <aside className='max-h-max w-60 rounded-r-xl bg-white px-3 py-8'>
        ...
        <form>
          ...
          <div className='relative mb-6'>
            ...
            <div className='relative'>
              ...
              >
                ...
                <option value='cats' className='text-black'>
                  Cats
                </option>
                <option value='fishes' className='text-black'>
                  Fishes
                </option>
                <option value='parrots' className='text-black'>
                  Parrots
                </option>
                {/* More categories */}
              </select>
          ...
          <div className='mb-6'>
            ...
            <div className='flex items-center justify-center space-x-2'>
              <input
                ...
                id='priceMin'
                placeholder='Min'
                className='w-1/2 rounded-[4px] border border-[#00000099] bg-transparent px-2 py-1 text-xs outline-none placeholder:font-semibold placeholder:text-[#00000066]'
              />
          ...
          <div className='mb-6'>
            ...
            <div className='flex space-x-2'>
              <input
                ...
                className='w-full rounded-md border border-[#00000099] bg-transparent px-3 py-2 text-xs outline-none placeholder:font-semibold placeholder:text-[#00000066]'
              />
            </div>
          </div>
          ...
          <div className='mb-6'>
            ...
            <div className='flex space-x-2'>
              <textarea
                ...
                className='h-16 w-full resize-none rounded-md border border-[#00000099] bg-transparent px-3 py-2 text-xs outline-none placeholder:font-semibold placeholder:text-[#00000066]'
              />
            </div>
          </div>
          ...
          <button
            type='submit'
            className='mb-6 w-full rounded-lg bg-tertiary px-4 py-2 text-xs font-semibold text-white'
          >
            Apply Filters
          </button>
        </form>
